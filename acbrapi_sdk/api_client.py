...
import acbrapi_sdk.models
from acbrapi_sdk import rest
from acbrapi_sdk.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'acbrapi-sdk/{packageVersion}/{language}'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(acbrapi_sdk.models, klass)
