...
class NfsePedidoSincronizacao(object):
    ...
    def __init__(self, identificador=None, local_vars_configuration=None):  # noqa: E501
        """NfsePedidoSincronizacao - a model defined in OpenAPI"""  # noqa: E501
    ...
    def identificador(self, identificador):
        """Sets the identificador of this NfsePedidoSincronizacao.

        Identificador utilizado na consulta da situação atual da NFS-e.    O valor desse campo é opcional para as prefeituras que suportem consultas por número e série do RPS.  Para as demais, esse campo torna-se obrigatório e o seu valor pode ser a chave de acesso, número da NFS-e, chave de verificação, protocolo ou outro identificador da nota a depender da prefeitura.  # noqa: E501

        :param identificador: The identificador of this NfsePedidoSincronizacao.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NfsePedidoSincronizacao):
            return False
