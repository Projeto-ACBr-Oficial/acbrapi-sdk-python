...
**mod** | **int** | Modelo do documento fiscal.  Utilizar o código 67 para identificação do CT-e Outros Serviços, emitido em substituição a Nota Fiscal Modelo 7 para transporte de pessoas, valores e excesso de bagagem. | [opcional] 
...
**modal** | **str** | Modal. Preencher com:  * 01 - Rodoviário  * 02 - Aéreo  * 03 - Aquaviário  * 04 - Ferroviário | 
...
**c_mun_ini** | **str** | Código do Município de início da prestação.  Utilizar a tabela do IBGE. Informar 9999999 para operações com o exterior. | [opcional] 
**x_mun_ini** | **str** | Nome do Município do início da prestação.  Informar &#39;EXTERIOR&#39; para operações com o exterior. | [opcional] 
**uf_ini** | **str** | UF do início da prestação.  Informar &#39;EX&#39; para operações com o exterior. | [opcional] 
**c_mun_fim** | **str** | Código do Município de término da prestação.  Utilizar a tabela do IBGE. Informar 9999999 para operações com o exterior. | [opcional] 
**x_mun_fim** | **str** | Nome do Município do término da prestação.  Informar &#39;EXTERIOR&#39; para operações com o exterior. | [opcional] 
**uf_fim** | **str** | UF do término da prestação.  Informar &#39;EX&#39; para operações com o exterior. | [opcional] 
**inf_percurso** | [**list[CteOsSefazInfPercursoOS]**](CteOsSefazInfPercursoOS.md) |  | [opcional] 
...
**g_compra_gov** | [**CteOsSefazCompraGovReduzidoOS**](CteOsSefazCompraGovReduzidoOS.md) |  | [opcional] 
