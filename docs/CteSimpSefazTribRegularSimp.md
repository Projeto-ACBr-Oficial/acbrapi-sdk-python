...
------------ | ------------- | ------------- | -------------
**cst_reg** | **str** | Código da Situação Tributária do IBS e CBS.  Informar qual seria o CST caso não cumprida a condição resolutória/suspensiva. | 
**c_class_trib_reg** | **str** | Informar qual seria o cClassTrib caso não cumprida a condição resolutória/suspensiva. | 
