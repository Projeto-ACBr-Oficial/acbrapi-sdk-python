...
**c_dc** | **str** | Código numérico que compõe a Chave de Acesso.  Código aleatório gerado pelo emitente, com o objetivo de evitar acessos indevidos ao documento.    *Geramos automaticamente quando nenhum valor é informado.* | [opcional] 
**mod** | **int** | Modelo da DCe.  Utilizar o código 99 para identificação da DCe. | [opcional] 
...
**ver_proc** | **str** | Versão do processo de emissão.  Informar a versão do aplicativo emissor de DCe. | 
