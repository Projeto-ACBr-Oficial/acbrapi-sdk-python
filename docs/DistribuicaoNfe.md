...
**cons_chave** | **str** | Consulta de NF-e por chave de acesso informada.    *Obrigatório quando &#x60;tipo_consulta&#x60; for &#x60;consChNFe&#x60;.* | [optional] 
**codigo_status** | **int** | Código do status de processamento da requisição. | 
**motivo_status** | **str** | Descrição do status de processamento da requisição. | [optional] 
