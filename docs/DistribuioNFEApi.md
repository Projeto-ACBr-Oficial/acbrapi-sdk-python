...
with acbrapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->baixar_pdf_documento_distribuicao_nfe: %s\n" % e)
```
...
with acbrapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->baixar_xml_documento_distribuicao_nfe: %s\n" % e)
```
...
with acbrapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->consultar_distribuicao_nfe: %s\n" % e)
```
...
with acbrapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->consultar_documento_distribuicao_nfe: %s\n" % e)
```
...
with acbrapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->consultar_manifestacao_nfe: %s\n" % e)
```
...
with acbrapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->gerar_distribuicao_nfe: %s\n" % e)
```
...
inlinecount = False # bool | Inclui no JSON de resposta, na propriedade `@count`, o número total de registros que o filtro retornaria, independente dos filtros de paginação. (opcional) (default False)
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->listar_distribuicao_nfe: %s\n" % e)
```
...
skip = 0 # int | Quantidade de objetos que serão ignorados antes da lista começar a ser retornada. (opcional) (default 0)
inlinecount = False # bool | Inclui no JSON de resposta, na propriedade `@count`, o número total de registros que o filtro retornaria, independente dos filtros de paginação. (opcional) (default False)
dist_nsu = 56 # int | Filtrar por documentos a partir do NSU informado. (opcional)
tipo_documento = 'tipo_documento_example' # str | Filtrar pelo tipo do documento de interesse da pessoa ou empresa.    Valores aceitos: `nota`, `evento` (opcional)
forma_distribuicao = 'forma_distribuicao_example' # str | Filtrar por documentos que foram distribuídos em sua forma resumida ou completa.    Valores aceitos: `resumida`, `completa` (opcional)
chave_acesso = 'chave_acesso_example' # str | Filtrar pela chave de acesso da NF-e. (opcional)
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->listar_documento_distribuicao_nfe: %s\n" % e)
```
 ...
 **skip** | **int**| Quantidade de objetos que serão ignorados antes da lista começar a ser retornada. | [opcional] [default 0]
 **inlinecount** | **bool**| Inclui no JSON de resposta, na propriedade &#x60;@count&#x60;, o número total de registros que o filtro retornaria, independente dos filtros de paginação. | [opcional] [default False]
 **dist_nsu** | **int**| Filtrar por documentos a partir do NSU informado. | [opcional] 
 **tipo_documento** | **str**| Filtrar pelo tipo do documento de interesse da pessoa ou empresa.    Valores aceitos: &#x60;nota&#x60;, &#x60;evento&#x60; | [opcional] 
 **forma_distribuicao** | **str**| Filtrar por documentos que foram distribuídos em sua forma resumida ou completa.    Valores aceitos: &#x60;resumida&#x60;, &#x60;completa&#x60; | [opcional] 
 **chave_acesso** | **str**| Filtrar pela chave de acesso da NF-e. | [opcional] 
...
inlinecount = False # bool | Inclui no JSON de resposta, na propriedade `@count`, o número total de registros que o filtro retornaria, independente dos filtros de paginação. (opcional) (default False)
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->listar_manifestacao_nfe: %s\n" % e)
```
...
conclusiva = False # bool | Indica se serão consideradas apenas as manifestações conclusivas.    Valores:  * `false`: serão retornadas notas que não possuírem qualquer tipo de    manifestação.    * `true`: apenas as notas que não possuírem manifestação conclusiva    serão retornadas. Ou seja, notas que tenham sido manifestadas apenas    com Ciência da Operação (210210) continuarão sendo retornadas por    esse endpoint até que recebam uma manifestação conclusiva. (opcional) (default False)
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->listar_nfe_sem_manifestacao: %s\n" % e)
```
...
with acbrapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Excecao ao chamar DistribuioNFEApi->manifestar_nfe: %s\n" % e)
```
