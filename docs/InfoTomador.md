...
------------ | ------------- | ------------- | -------------
**orgao_publico** | **bool** | Indica se o tomador do serviço - um órgão público.    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado. | [optional] [default to False]
