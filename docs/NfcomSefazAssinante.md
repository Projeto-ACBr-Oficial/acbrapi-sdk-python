...
**n_contrato** | **str** | Número do Contrato do assinante. | [opcional] 
**d_contrato_ini** | **date** | Data de início do contrato.  Formato AAAA-MM-DD. | [opcional] 
**d_contrato_fim** | **date** | Data de término do contrato.  Formato AAAA-MM-DD. | [opcional] 
**nro_term_princ** | **str** | Número do Terminal Principal do serviço contratado.  Em se tratando de plano de prestação de serviço telefônico corporativo, familiar ou similares, informar o número do terminal telefônico principal do plano. | [opcional] 
**c_uf_princ** | **int** | Código da UF de habilitação do terminal.  Utilizar a  Tabela do IBGE de código de unidades da federação. | [opcional] 
**nro_term_adic** | **str** | Número dos Terminais adicionais do serviço contratado. | [opcional] 
**c_uf_adic** | **int** | Código da UF de habilitação do terminal. | [opcional] 
