...
**codif** | **str** | Código de autorização / registro do CODIF. Informar apenas quando a UF utilizar o CODIF (Sistema de Controle do    Diferimento do Imposto nas Operações com AEAC - Álcool Etílico Anidro Combustível). | [optional] 
...
**orig_comb** | [**list[NfeSefazOrigComb]**](NfeSefazOrigComb.md) |  | [optional] 
