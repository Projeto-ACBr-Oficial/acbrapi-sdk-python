...
**v_afrmm** | **float** | Valor Adicional ao frete para renovação de marinha mercante. | [opcional] 
**tp_intermedio** | **int** | Forma de Importação quanto a intermediação  * 1 - por conta propria  * 2 - por conta e ordem  * 3 - encomenda | 
**cnpj** | **str** | CNPJ do adquirente ou do encomendante. | [opcional] 
**cpf** | **str** | CPF do adquirente ou do encomendante. | [opcional] 
**uf_terceiro** | **str** | Sigla da UF do adquirente ou do encomendante. | [opcional] 
