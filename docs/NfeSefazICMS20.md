...
**mot_des_icms** | **int** | Motivo da desoneração do ICMS:3-Uso na agropecuária  * 9 - Outros  * 10 - Deficiente Condutor (Convênio ICMS 38/12)  * 11 - Deficiente Não Condutor (Convênio ICMS 38/12)  * 12 - Fomento agropecuário | [optional] 
