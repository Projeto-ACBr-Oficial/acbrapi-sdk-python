...
**cst** | **str** | Tributação pelo ICMS 51 - Tributação com Diferimento. | 
...
**c_benef_rbc** | **str** | Código de Benefício Fiscal na UF aplicado ao item quando houver RBC. | [optional] 
