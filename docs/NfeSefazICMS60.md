...
**cst** | **str** | Tributação pelo ICMS  * 60 - ICMS cobrado anteriormente por substituição tributária | 
**v_bcst_ret** | **float** | Valor da BC do ICMS ST retido anteriormente. | [opcional] 
...
**v_icmsst_ret** | **float** | Valor do ICMS ST retido anteriormente. | [opcional] 
**v_bcfcpst_ret** | **float** | Valor da Base de cálculo do FCP retido anteriormente por ST. | [opcional] 
