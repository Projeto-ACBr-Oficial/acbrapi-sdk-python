...
**cst** | **str** | Tributção pelo ICMS  * 61 - Tributação monofásica sobre combustíveis cobrada anteriormente | 
**q_bc_mono_ret** | **float** | Quantidade tributada retida anteriormente. | [opcional] 
