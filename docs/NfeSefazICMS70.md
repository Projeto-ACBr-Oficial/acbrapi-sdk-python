...
**cst** | **str** | Tributção pelo ICMS  * 70 - Com redução de base de cálculo e cobrança do ICMS por substituição tributária | 
...
**v_bcfcpst** | **float** | Valor da Base de cálculo do FCP retido por substituição tributária. | [opcional] 
