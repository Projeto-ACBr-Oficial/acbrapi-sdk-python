...
**cst** | **str** | Tributção pelo ICMS  * 41 - Não Tributado  * 60 - Cobrado anteriormente por substituição tributária | 
...
**v_icms_substituto** | **float** | Valor do ICMS Próprio do Substituto cobrado em operação anterior. | [opcional] 
**v_icmsst_ret** | **float** | Informar o valor do ICMS ST retido na UF remetente (iv2.0)). | 
**v_bcfcpst_ret** | **float** | Informar o valor da Base de Cálculo do FCP retido anteriormente por ST. | [opcional] 
**p_fcpst_ret** | **float** | Percentual relativo ao Fundo de Combate à Pobreza (FCP) retido por substituição tributária. | [opcional] 
**v_fcpst_ret** | **float** | Valor do ICMS relativo ao Fundo de Combate à Pobreza (FCP) retido por substituição tributária. | [opcional] 
...
**p_icms_efet** | **float** | Alíquota do ICMS efetivo. | [opcional] 
