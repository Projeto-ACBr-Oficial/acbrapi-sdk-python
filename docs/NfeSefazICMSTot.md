...
**v_fcpuf_dest** | **float** | Valor total do ICMS relativo ao Fundo de Combate à Pobreza (FCP) para a UF de destino. | [opcional] 
**v_icmsuf_dest** | **float** | Valor total do ICMS de partilha para a UF do destinatário. | [opcional] 
**v_icmsuf_remet** | **float** | Valor total do ICMS de partilha para a UF do remetente. | [opcional] 
...
**q_bc_mono** | **float** | Valor total da quantidade tributada do ICMS monofásico próprio. | [opcional] 
**v_icms_mono** | **float** | Valor total do ICMS monofásico próprio. | [opcional] 
**q_bc_mono_reten** | **float** | Valor total da quantidade tributada do ICMS monofásico sujeito a retenção. | [opcional] 
**v_icms_mono_reten** | **float** | Valor total do ICMS monofásico sujeito a retenção. | [opcional] 
**q_bc_mono_ret** | **float** | Valor total da quantidade tributada do ICMS monofásico retido anteriormente. | [opcional] 
**v_icms_mono_ret** | **float** | Valor do ICMS monofásico retido anteriormente. | [opcional] 
